export default {
  ...
  'hero.headline': '教机器去看世界',
  'hero.standfirst': '合肥工业大学智能科学与技术本科。专注计算机视觉与深度学习，把论文里的模型做成能跑起来的东西。',
  'hero.name': '李亚泽',
  'hero.role': '智能科学与技术 · 合肥工业大学',
  'hero.location': '中国 · 合肥',
  'hero.scroll': '向下阅读',
  'about.title': '关于',
  'about.kicker': '编者按',
  'about.name': '李亚泽',
  'about.role': '智能科学与技术 · 合肥工业大学',
  'about.label.github': 'GitHub',
  'about.label.email': '邮箱',
  'about.label.degree': '学位',
  'about.cert': '证书',
  ...
  'projects.group.solo': '独立开发',
  'projects.group.collab': '参与开发',
  'projects.cat.vision': '视觉',
  'projects.cat.system': '系统',
